...
from fitness.models import Workout, MuscleGroup, Exercise, WorkingSet, WorkoutComment
...
class MuscleGroupUrlTest(TestCase):
    ...
    def setUp(self):
        ...
        self.edit_musclegroup_url = reverse('edit-musclegroup', kwargs={'musclegroup_id': 1})
        self.delete_musclegroup_url = reverse('delete-musclegroup', kwargs={'musclegroup_id': 1})
    ...
    def test_url_resolves_musclegroups_create_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        # Test if the URL uses the correct view
        self.assertEqual(response.resolver_match.view_name, 'create-musclegroup')
        # Test if the URL renders the correct template
    ...
    def test_url_resolves_musclegroups_delete_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        # Test if the URL uses the correct view
        self.assertEqual(response.resolver_match.view_name, 'delete-musclegroup')
        # Test if the URL renders the correct template
...
class ExerciseUrlTest(TestCase):
    ...
    def setUp(self):
        ...
        self.edit_exercise_url = reverse('edit-exercise', kwargs={'exercise_id': 1})
        self.delete_exercise_url = reverse('delete-exercise', kwargs={'exercise_id': 1})
    ...
    def test_url_resolves_exercises_collection_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        # Test if the URL uses the correct view
        self.assertEqual(response.resolver_match.view_name, 'collection-exercise')
        # Test if the URL renders the correct template
...
class WorkoutUrlTest(TestCase):
    ...
    def setUp(self):
        ...
        self.edit_workout_url = reverse('edit-workout', kwargs={'workout_id': 1})
        self.delete_workout_url = reverse('delete-workout', kwargs={'workout_id': 1})
        self.view_workout_url = reverse('view-private-workout', kwargs={'workout_id': 1})
    ...
    def test_url_resolves_workouts_view_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        # Test if the URL uses the correct view
        self.assertEqual(response.resolver_match.view_name, 'view-private-workout')
        # Test if the URL renders the correct template
...
class ExerciseToWorkoutUrlTest(TestCase):
    ...
    def setUp(self):
        ...
        self.select_exercise_url = reverse('select-exercise', kwargs={'workout_id': 1})
        self.remove_exercise_url = reverse('remove-exercise', kwargs={'exercise_id': 1})
    ...
    def test_url_resolves_select_exercise_page(self):
        ...
        # Test if the URL renders the correct template
        self.assertTemplateUsed(response, 'exercise_to_workout/select_exercise.html')
    ...
    def test_url_resolves_remove_exercise_page(self):
        ...
        # Test if the URL renders the correct template
        self.assertTemplateUsed(response, 'exercise_to_workout/remove_exercise.html')
...
class WorkingSetsUrlTest(TestCase):
    ...
    def setUp(self):
        ...
        self.create_set_url = reverse('create-set', kwargs={'exercise_id': 1, 'workout_id': 1})
        self.edit_set_url = reverse('edit-set', kwargs={'workingset_id': 1})
        self.delete_set_url = reverse('delete-set', kwargs={'workingset_id': 1})
...
class PublicWorkoutsUrlTest(TestCase):
    ...
    def setUp(self):
        ...
        self.view_public_workout_url = reverse('view-public-workout', kwargs={'workout_id': 1})
    ...
    def test_url_resolves_view_public_workout_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        # Test if the URL uses the correct view
        self.assertEqual(response.resolver_match.view_name, 'view-public-workout')
        # Test if the URL renders the correct template
...
class WorkoutCommentsUrlTest(TestCase):
    ...
    def setUp(self):
        ...
        self.edit_commet_url = reverse('edit-comment', kwargs={'workout_id': 1, 'comment_id': 1})
        self.delete_commet_url = reverse('delete-comment', kwargs={'workout_id': 1, 'comment_id': 1})
...
class AnalysisUrlTest(TestCase):
    ...
    def test_url_resolves_analyze_bodyweight_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        # Test if the URL uses the correct view
        self.assertEqual(response.resolver_match.view_name, 'analyze-bodyweight')
        # Test if the URL renders the correct template
