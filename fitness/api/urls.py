...
router.register(
    r"musclegroups", views.MuscleGroupAPIView, basename="musclegroups"
)
...
router.register(
    r"workout-exercises",
    views.WorkoutExerciseAPIView,
    basename="workout-exercises",
)
...
router.register(
    r"workouts-detailed",
    views.DetailedWorkoutAPIView,
    basename="workouts-detailed",
)
